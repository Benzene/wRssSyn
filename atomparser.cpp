...
AtomParser::AtomParser() : xmlpp::SaxParser() {
    in_entry = false;
    header_image = false;
}

AtomParser::AtomParser(sqlite3 * db, string id) : xmlpp::SaxParser() {
    in_entry = false;
    this->db = db;
    this->id = id;
    header_image = false;
...
void
AtomParser::on_start_element(const Glib::ustring& name,
...
void
AtomParser::on_comment(const Glib::ustring& text) {
//  std::cout << "Comments : " << text << endl;
}

void
AtomParser::on_warning(const Glib::ustring& text) {
  std::cout << "Warning : " << text << endl;
}

void
AtomParser::on_error(const Glib::ustring& text) {
  std::cout << "Error : " << text << endl;
}

void
AtomParser::on_fatal_error(const Glib::ustring& text) {
